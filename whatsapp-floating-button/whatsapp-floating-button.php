...
class WhatsApp_Floating_Button {
    ...
    public static function get_button_html( $args ) {
        ...
        <a href="<?php echo esc_url( $url ); ?>" class="<?php echo esc_attr( $class ); ?>" target="_blank" rel="nofollow" style="<?php echo esc_attr( $style ); ?>">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="white" style="width: 50%; height: 50%; display: block;">
    ...
    public function shortcode_handler( $atts ) {
        ...
        $atts = shortcode_atts( array(
            ...
            'color'       => isset( $options['shortcode_color'] ) ? $options['shortcode_color'] : '#25D366',
            'size'        => isset( $options['shortcode_size'] ) ? $options['shortcode_size'] : '50',
...
class WhatsApp_Button_Widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $button_args = array(
            ...
            'text'        => ! empty( $instance['text'] ) ? $instance['text'] : (isset($options['text']) ? $options['text'] : ''),
